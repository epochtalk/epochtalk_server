defmodule EpochtalkServerWeb.Helpers.Sanitize do
  ...
  ## Example
      ...
      iex> Sanitize.strip_html_from_title(attrs["title"], attrs)
      %{"title" => "Hello World"}
  """
  ...
  ## Example
      ...
      iex> Sanitize.strip_html_from_subject(attrs["subject"], attrs)
  ...
  Used to sanitize all html except basic formatting html from `Thread` or `Post` body
    ## Example
      ...
      iex> Sanitize.strip_html_from_body(attrs["body"], attrs)
      %{"body" => "<i>Hey <b>this</b> is</i><br /> <h1>a</h1> <a href=\\"google.com\\">post</a>"}
  """
  @spec strip_html_from_body(body :: String.t(), attrs :: map) :: map()
  def strip_html_from_body(body, attrs) when is_binary(body) and is_map(attrs),
