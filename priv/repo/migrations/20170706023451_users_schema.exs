defmodule EpochtalkServer.Repo.Migrations.UsersSchema do
  ...
  def change do
    ...
    execute(
      "ALTER TABLE ONLY users.bans ADD CONSTRAINT bans_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)"
    )
    ...
    execute(
      "ALTER TABLE ONLY users.board_bans ADD CONSTRAINT board_bans_board_id_fkey FOREIGN KEY (board_id) REFERENCES public.boards(id) ON DELETE CASCADE"
    )

    execute(
      "ALTER TABLE ONLY users.board_bans ADD CONSTRAINT board_bans_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE"
    )
    ...
    execute(
      "ALTER TABLE ONLY users.preferences ADD CONSTRAINT preferences_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)"
    )
    ...
    execute(
      "ALTER TABLE ONLY users.profiles ADD CONSTRAINT profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE"
    )
    ...
    execute(
      "ALTER TABLE ONLY users.thread_views ADD CONSTRAINT thread_views_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.threads(id) ON UPDATE CASCADE ON DELETE CASCADE"
    )

    execute(
      "ALTER TABLE ONLY users.thread_views ADD CONSTRAINT thread_views_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE"
    )
    ...
    execute(
      "ALTER TABLE ONLY users.watch_boards ADD CONSTRAINT watch_boards_board_id_fkey FOREIGN KEY (board_id) REFERENCES public.boards(id) ON DELETE CASCADE"
    )

    execute(
      "ALTER TABLE ONLY users.watch_boards ADD CONSTRAINT watch_boards_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE"
    )
    ...
    execute(
      "ALTER TABLE ONLY users.watch_threads ADD CONSTRAINT watch_threads_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.threads(id) ON DELETE CASCADE"
    )

    execute(
      "ALTER TABLE ONLY users.watch_threads ADD CONSTRAINT watch_threads_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE"
    )
  end
end
