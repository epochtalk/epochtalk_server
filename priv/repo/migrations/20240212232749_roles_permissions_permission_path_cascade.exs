defmodule EpochtalkServer.Repo.Migrations.RolesPermissionsPermissionPathCascade do
  ...
  def up do
    ...
    alter table(:roles_permissions) do
      modify :permission_path,
             references(:permissions, column: :path, type: :string, on_delete: :delete_all),
             null: false
    end
  end
  ...
  def down do
    ...
    alter table(:roles_permissions) do
      modify :permission_path,
             references(:permissions, column: :path, type: :string, on_delete: :nothing),
             null: false
    end
  end
end
